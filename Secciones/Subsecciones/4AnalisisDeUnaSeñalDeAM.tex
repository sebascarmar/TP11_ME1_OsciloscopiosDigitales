  ...
  \subsection{Análisis de una señal modulada en amplitud} \label{sec:Exp4_AM}
    ...
    \subsubsection{Señal cuadrada como modulante}
      ...
      \begin{figure}[H]
        \centering
        \frame{\includegraphics[width=0.44\textwidth]{Imagenes/ActividadPractica/4AnalisisDeUnaSeñalDeAM/Exp4_SeñalAM_CuadradaModulante.jpeg}}
    ...
    \subsubsection{Señal triangular como modulante}
      ...
      \begin{figure}[H]
        \centering
        \frame{\includegraphics[width=0.44\textwidth]{Imagenes/ActividadPractica/4AnalisisDeUnaSeñalDeAM/Exp4_SeñalAM_TriangularModulante.jpeg}}
